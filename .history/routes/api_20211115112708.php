...
Route::group(['middleware'=>'auth:sanctum'],function(){
    ...
    // UTILITY CATEGORY
    Route::post('payroll-type/archive/{id}', [UtilityCategoryController::class, 'archive']);
    Route::post('payroll-type/restore/{id}', [UtilityCategoryController::class, 'restore']);
    Route::post('payroll-type/search/', [UtilityCategoryController::class, 'search']);
    Route::resource('utility-category',UtilityCategoryController::class);
});
