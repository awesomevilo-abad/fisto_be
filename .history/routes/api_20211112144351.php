...
Route::group(['middleware'=>'auth:sanctum'],function(){
    ...
    // UTILITY CATEGORY
    Route::post('utilitycategory/archive/{id}', [UtilityCategoryController::class, 'archive']);
    Route::post('utilitycategory/restore/{id}', [UtilityCategoryController::class, 'restore']);
    Route::post('utilitycategory/search/', [UtilityCategoryController::class, 'search']);
    Route::resource('utilitycategory',UtilityCategoryController::class);

    // ACCOUNT #
    Route::post('accountnumber/archive/{id}', [AccountNumberController::class, 'archive']);
    Route::post('locations/restore/{id}', [AccountNumberController::class, 'restore']);
    Route::post('locations/search/', [AccountNumberController::class, 'search']);
    Route::resource('locations',AccountNumberController::class);
