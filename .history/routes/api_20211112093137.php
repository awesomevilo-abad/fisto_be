...
Route::group(['middleware'=>'auth:sanctum'],function(){
    ...
    // LOCATION
    Route::post('locations/archive/{id}', [DepartmentController::class, 'archive']);
    Route::post('locations/restore/{id}', [DepartmentController::class, 'restore']);
    Route::post('locations/search/', [DepartmentController::class, 'search']);
    Route::resource('locations',DepartmentController::class);
