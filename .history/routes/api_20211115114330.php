...
Route::group(['middleware'=>'auth:sanctum'],function(){
    ...
    // ACCOUNT TITLE
    Route::post('account-title/archive/{id}', [UtilityCategoryController::class, 'archive']);
    Route::post('account-title/restore/{id}', [UtilityCategoryController::class, 'restore']);
    Route::post('account-title/search/', [UtilityCategoryController::class, 'search']);
    Route::resource('account-title',UtilityCategoryController::class);
});
