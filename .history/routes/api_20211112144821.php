...
Route::group(['middleware'=>'auth:sanctum'],function(){
    ...
    // PAYROLL CATEGORY
    Route::post('payroll-category/archive/{id}', [PayrollCategoruController::class, 'archive']);
    Route::post('payroll-category/restore/{id}', [LocationController::class, 'restore']);
    Route::post('payroll-category/search/', [LocationController::class, 'search']);
    Route::resource('payroll-category',LocationController::class);
