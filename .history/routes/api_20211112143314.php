...
Route::group(['middleware'=>'auth:sanctum'],function(){
    ...
    Route::post('utilitycategory/restore/{id}', [LocationController::class, 'restore']);
    Route::post('utilitycategory/search/', [LocationController::class, 'search']);
    Route::resource('utilitycategory',LocationController::class);
