...
Route::group(['middleware'=>'auth:sanctum'],function(){
    ...
    // ACCOUNT TITLE
    Route::post('account-title/archive/{id}', [LocationController::class, 'archive']);
    Route::post('account-title/restore/{id}', [LocationController::class, 'restore']);
    Route::post('account-title/search/', [LocationController::class, 'search']);
    Route::resource('account-title',LocationController::class);
