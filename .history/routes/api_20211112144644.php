...
Route::group(['middleware'=>'auth:sanctum'],function(){
    ...
    // PAYROLL CLIENT
    Route::post('payroll-client/archive/{id}', [LocationController::class, 'archive']);
    Route::post('payroll-client/restore/{id}', [LocationController::class, 'restore']);
    Route::post('payroll-client/search/', [LocationController::class, 'search']);
    Route::resource('payroll-client',LocationController::class);
