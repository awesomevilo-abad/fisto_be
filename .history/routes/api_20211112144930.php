...
Route::group(['middleware'=>'auth:sanctum'],function(){
    ...
    // PAYROLL TYPE
    Route::post('payroll-type/archive/{id}', [LocationController::class, 'archive']);
    Route::post('payroll-type/restore/{id}', [LocationController::class, 'restore']);
    Route::post('payroll-type/search/', [LocationController::class, 'search']);
    Route::resource('payroll-type',LocationController::class);
