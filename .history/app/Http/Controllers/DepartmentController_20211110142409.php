...
class DepartmentController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $fields = $request->validate([
            ...
            'department' => 'required',Rule::unique('departments')->where(function ($query) use ($department,$company){
                return $query->where('department',"Corporate Common")
                ->where('company',"Corporate Common");
            }),
            'is_active' => 'required'
        ]);
        $messages;
