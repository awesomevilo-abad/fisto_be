...
class DepartmentController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $fields = $request->validate([
            'code' => 'nullable',
            'department' =>'string|unique:departments,department|unique:departments,department|different:phone2|min:2',
            'company' =>'string|unique:departments,company|unique:departments,phone1|different:phone1|min:2',
        ]);
