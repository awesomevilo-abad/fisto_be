...
class DepartmentController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $fields = $request->validate([
            'code' => 'nullable',
            'department' =>'unique:departments,department|unique:departments,company|different:company|min:2',
            'company' =>'unique:departments,company|unique:departments,department|different:department|min:2',
        ]);
