...
class PayrollCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $new_payroll_clients = PayrollCategory::create([
    ...
    public function update(Request $request, $id)
    {
        ...
        $specific_payroll_clients = PayrollCategory::find($id);
        ...
        if (!$specific_payroll_clients) {
            ...
            $specific_payroll_clients->client = $request->get('client');
