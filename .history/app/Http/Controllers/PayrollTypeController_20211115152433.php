...
class PayrollTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $new_payroll_types = PayrollCategory::create([
    ...
    {
        $payroll_types = $request['category'];
        $fields = $request->validate([
            'category' => ['unique:payroll_types,category,' . $id]
        ]);

        $specific_payroll_types = PayrollCategory::find($id);
        ...
        if (!$specific_payroll_types) {
            ...
            $specific_payroll_types->category = $request->get('category');
