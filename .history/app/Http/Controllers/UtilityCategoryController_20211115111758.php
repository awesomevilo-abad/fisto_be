...
class UtilityCategoryController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $fields = $request->validate([
            'category' => ['unique:coutility_categoriesmpanies,company_code,' . $id],
        ...
        if (!$specific_utility_categories) {
            ...
            $specific_utility_categories->company_code = $request->get('company_code');
            $specific_utility_categories->company_description = $request->get('company_description');
