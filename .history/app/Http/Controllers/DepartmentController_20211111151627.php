...
class DepartmentController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $fields = $request->validate([
            'code' => 'nullable',
            'department' =>'string|unique:departments,department|unique:tbl_users,phone2|different:phone2|min:2',
            'company' =>'string|unique:departments,pcompanyhone2|unique:tbl_users,phone1|different:phone1|min:2',
        ]);
