...
class AccountTitleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $new_utility_categories = AccountTitle::create([
     ...
     *
     * @param  \App\Models\AccountTitle  $utilityCategory
     * @return \Illuminate\Http\Response
     */
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(AccountTitle $utilityCategory)
    {
        //
    }
    ...
    {
        $specific_utility_categories = AccountTitle::find($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(AccountTitle $utilityCategory)
    {
        //
    }
