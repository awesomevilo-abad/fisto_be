...
class UtilityCategoryController extends Controller
{
    ...
    {
        $specific_utility_categories = Department::find($id);

        $fields = $request->validate([
            'code' => 'nullable',
            'utility_categories' =>['unique:utility_categoriess,utility_categories,'.$id],
            'company' => 'nullable',
        ]);
        ...
        $specific_utility_categories->code = $fields['code'];
        $specific_utility_categories->utility_categories = $fields['utility_categories'];
        $specific_utility_categories->company = $fields['company'];
