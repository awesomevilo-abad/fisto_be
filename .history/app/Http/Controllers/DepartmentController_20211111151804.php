...
class DepartmentController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $fields = $request->validate([
            'code' => 'nullable',
            'department' =>'string|unique:departments,department|unique:departments,company|different:company|min:2',
            'company' =>'string|unique:departments,company|unique:departments,department|different:department|min:2',
        ]);
        ...
        ->where( function($query) use($fields){
            $query->where('department',$fields['department'])
