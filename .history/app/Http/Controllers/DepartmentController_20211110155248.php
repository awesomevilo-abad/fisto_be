...
class DepartmentController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $validate_department_company = Department::where('department',$request['department'])
        ->where('company',$request['company'])->get();

        if(!isset($validate_department_company)){
            return $this->result('','Data Not Found',null);
        }
        ...
        return $this->result(200,'Data Not Found',null);
        return [
            $response = [
                "code" => 200,
