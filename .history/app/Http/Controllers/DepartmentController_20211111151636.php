...
class DepartmentController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $fields = $request->validate([
            'code' => 'nullable',
            'department' =>'string|unique:departments,department|unique:departments,phone2|different:phone2|min:2',
            'company' =>'string|unique:departments,company|unique:tbl_udepartmentssers,phone1|different:phone1|min:2',
        ]);
