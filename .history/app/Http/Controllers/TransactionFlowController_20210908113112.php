...
class TransactionFlowController extends Controller
{
    ...
    public function receivedRequest(Request $request,$id){
        return $transactions = TransactionFlow::pullSingleRequest($process,$id);
        $process =  $request['process'];
        ...
        return TransactionFlow::receivedRequest($process, $id, $description, $reason_id, $remarks, $date_received, $date_status);
    }
}
