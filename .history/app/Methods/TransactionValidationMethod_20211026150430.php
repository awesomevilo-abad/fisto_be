...
class TransactionValidationMethod
 {
    ...
    public static function receiptValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        foreach($fields['po_group'] as $specific_po_details){
            ...
            return $po_allowable_amount =  TransactionValidationMethod::getAllowableAmount($fields['is_allowable'],TransactionValidationMethod::convertStringToNumber($specific_po_details['po_amount']));
