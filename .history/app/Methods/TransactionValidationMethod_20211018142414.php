...
class TransactionValidationMethod
 {
    ...
    public static function padValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        $insertTransaction = TransactionValidationMethod::insertTransaction($fields,$transaction_id,$validated_transaction['po_total_amount'],$validated_transaction['po_total_amount'],$tag_id,$date_requested,$status);
