...
class TransactionValidationMethod
 {
    ...
    public static function receiptValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        $referrenceNoValidation = TransactionValidationMethod::referrenceNoValidaton($fields['supplier_id'],$fields['supplier_id'],$fields['supplier_id']$fields['referrence_group'][0]['referrence_no']);
