        ...
        if(isset($additional_po)){
            foreach($additional_po as $specific_additional_po){
                ...
                if(GenericMethod::validateIfPONoExistInDifferentSupplier($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$specific_additional_po) > 0){
                    $duplicate_po_in_additional_po[] = $po_no ;
                 }
            }
            ...
            if($additional_po_amount_plus_balance < $referrence_amount ){
                return TransactionValidationMethod::result(400,"Referrence Amount is greater than Total PO Amount, Additional PO Required",array(["referrence_amount"=>$referrence_amount, "total_po_amount"]));
            }
           return $balance_po_ref_amount =  $additional_po_amount_plus_balance - $referrence_amount;
        }
