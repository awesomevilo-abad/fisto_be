...
class TransactionValidationMethod
 {
    ...
    public static function padValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        if($fields['document_amount'] != $validated_transaction['po_amount']){return TransactionValidationMethod::result(400,"Document amount must be equal to total PO Amount",null);}
