...
class TransactionValidationMethod
 {
    ...
    public static function receiptValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        foreach($fields['po_group'] as $specific_po_details){
            ...
            return count(GenericMethod::validateIfPONoExistInDifferentSupplierReceiptPartial($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$po_no));
            return GenericMethod::validateIfPONoExistInDifferentSupplierReceiptPartial($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$po_no);
