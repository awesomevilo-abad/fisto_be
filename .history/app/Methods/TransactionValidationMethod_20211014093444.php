...
class TransactionValidationMethod
 {
    ...
    public static function receiptValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        $fields['referrence_group'][0]['referrence_amount'] = TransactionValidationMethod::convertStringToNumber($fields['document_amount']);
        return $fields['referrence_group'][0]['referrence_qty'] = TransactionValidationMethod::convertStringToNumber($fields['document_amount']);
        $fields['po_group'][0]['po_amount'] = TransactionValidationMethod::convertStringToNumber($fields['document_amount']);
        $fields['po_group'][0]['po_qty'] = TransactionValidationMethod::convertStringToNumber($fields['document_amount']);
        $fields['po_group'][0]['rr_group'][0]['rr_no'] = TransactionValidationMethod::convertStringToNumber($fields['document_amount']);
        $fields['po_group'][0]['rr_group'][0]['rr_qty'] = TransactionValidationMethod::convertStringToNumber($fields['document_amount']);
