...
class TransactionValidationMethod
 {
    ...
    public static function padWithCIP($fields,$tag_id,$date_requested,$status,$transaction_id){

    }

    public static function prmWithCIPV($fields,$tag_id,$date_requested,$status,$transaction_id){
