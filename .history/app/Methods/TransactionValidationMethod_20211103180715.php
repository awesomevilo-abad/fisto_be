        ...
        if(isset($existing_po)){
            ...
            if(isset($additional_po)){
                ...
                if(isset($additional_po_qty_plus_balance)){
                    $balance_po_ref_qty =  $additional_po_amount_plus_balance - $referrence_amount;
                }

                
                return $balance_po_ref_qty =  $additional_po_qty_plus_balance - $fields['referrence_group'][0]['referrence_qty'];
