...
class TransactionValidationMethod
 {
    ...
    public static function insertPartialTransaction($fields,$transaction_id,$po_total_amount,$po_total_qty,$tag_id,$date_requested,$status,$po_no){
        ...
        if(strtoupper($fields['referrence_group'][0]['referrence_type'])=="DR"){
        ...
        if($balance_document_po_amount->isEmpty()){
            ...
            // First Transaction
        return $balance_po_ref_amount = $po_total_amount - $referrence_total_amount;
            return 'transaction_id'."=". $transaction_id."<br>"."users_id"."=". $fields['users_id']
            ."<br>". "id_prefix"."=". $fields['id_prefix']
            ."<br>". "id_no"."=". $fields['id_no']
            ."<br>". "first_name"."=". $fields['first_name']
            ."<br>". "middle_name"."=". $fields['middle_name']
            ."<br>". "last_name"."=". $fields['last_name']
            ."<br>". "suffix"."=". $fields['suffix']
            ."<br>". "department"."=". $fields['department']
            ."<br>". "document_id"."=". $fields['document_id']
            ."<br>". "document_type"."=". $fields['document_type']
            ."<br>". "payment_type"."=". $fields['payment_type']
            ."<br>". "category_id"."=". $fields['category_id']
            ."<br>". "category"."=". $fields['category']
            ."<br>". "company_id"."=". $fields['company_id']
            ."<br>". "company"."=". $fields['company']
            ."<br>". "document_no"."=". $fields['document_no']
            ."<br>". "supplier_id"."=". $fields['supplier_id']
            ."<br>". "supplier"."=". $fields['supplier']
            ."<br>". "document_date"."=". $fields['document_date']
            ."<br>". "document_amount"."=". $fields['document_amount']
            ."<br>". "remarks"."=". $fields['remarks']
            ."<br>". "po_total_amount"."=". $po_total_amount
            ."<br>". "po_total_qty"."=". $po_total_qty
            ."<br>". "referrence_total_amount"."=".$referrence_total_amount
            ."<br>". "referrence_total_qty"."=". $referrence_total_qty

            ."<br>". "tag_id"."=". $tag_id
            ."<br>". "tagging_tag_id"."=". 0
            ."<br>". "date_requested"."=". $date_requested
            ."<br>". "status"."=". $status

            ."<br>". "utilities_category"."=". $fields['utilities_category']
            ."<br>". "utilities_account_no"."=". $fields['utilities_account_no']
            ."<br>". "utilities_consumption"."=". $fields['utilities_consumption']
            ."<br>". "utilities_uom"."=". $fields['utilities_uom']
            ."<br>". "utilities_receipt_no"."=". $fields['utilities_receipt_no']
            ."<br>". "utilities_from"."=". $fields['utilities_from']
            ."<br>". "utilities_to"."=". $fields['utilities_to']

            ."<br>". "payroll_client"."=". $fields['payroll_client']
            ."<br>". "payroll_category"."=". $fields['payroll_category']
            ."<br>". "payroll_type"."=". $fields['payroll_type']
            ."<br>". "payroll_from"."=". $fields['payroll_from']
            ."<br>". "payroll_to"."=". $fields['payroll_to']

            ."<br>". "pcf_date"."=". $fields['pcf_date']
            ."<br>". "pcf_letter"."=". $fields['pcf_letter']

            ."<br>". "balance_po_ref_amount"."=". $balance_po_ref_amount;
        }
