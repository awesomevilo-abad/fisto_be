...
class TransactionValidationMethod
 {
    ...
    public static function receiptValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        return $referrenceNoValidation = TransactionValidationMethod::referrenceNoValidaton($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$fields['referrence_group'][0]['referrence_no']);
