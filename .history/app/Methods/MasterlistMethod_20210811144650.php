                ...
                foreach($get_user_document_categories as $specific_user_document_categories){
                    ...
                    foreach ($users as $specific_user) {
                        ...
                        foreach ($document_types as $key => $value) {
                            ...
                            echo $get_user_document_categories->document_id;

                            // if($document_types[$key]->document_id == $get_user_document_categories->document_id ){
                            //     echo "Meron";
                            // }else{
                            //     echo "Wa;a";
                            // }
                            // echo 'USER_DOCUMENT_CATEGORY '.$specific_user_document_categories->user_id.'-----'.'USER  '.$specific_user->id;
