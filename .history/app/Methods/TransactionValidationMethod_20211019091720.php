...
class TransactionValidationMethod
 {
    ...
    public static function padValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        $validated_full_po_transaction= TransactionValidationMethod::fullPOValidationAndCreateTransaction($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$fields['po_group']);
