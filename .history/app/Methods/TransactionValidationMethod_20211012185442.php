...
class TransactionValidationMethod
 ...
 public static function validateIfInsertTransactionRequirementsAreNotEmpty($fields,$transaction_id,$po_total_amount,$po_total_qty,$tag_id,$date_requested,$status){
    $fields = $fields ?? null;
    $transaction_id = $transaction_id ?? null;
    $po_total_amount = $po_total_amount ?? null;
    $po_total_qty = $po_total_qty ?? null;
    $tag_id = $tag_id ?? null;
    $date_requested = $date_requested ?? null;
    $status = $status ?? null;
 }
...
public static function prmValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
    ...
    return TransactionValidationMethod::validateIfInsertTransactionRequirementsAreNotEmpty($fields,$transaction_id,$po_total_amount,$po_total_qty,$tag_id,$date_requested,$status);
    $insertTransaction = TransactionValidationMethod::insertTransaction($fields,$transaction_id,$po_total_amount,$po_total_qty,$tag_id,$date_requested,$status);
