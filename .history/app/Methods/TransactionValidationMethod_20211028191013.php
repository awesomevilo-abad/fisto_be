            ...
            foreach($fields['po_group'] as $specific_po_details){
                foreach($additional_po as $specific_additional_po){
                    ...
                    if($specific_additional_po == $specific_po_details['po_no']){
                        $additional_po_total_amount= TransactionValidationMethod::convertStringToNumber($specific_po_details['po_amount']);
                        ...
                        // $balance_ref_po_amount =  $balance_ref_po_amount[0]->balance_po_ref_amount;
