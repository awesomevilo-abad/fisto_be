            ...
            if(isset($additional_po)){
                ...
                if((strtoupper($referrence_type)=="DR") AND ($referrence_amount == NULL)){
                    ...
                    if($additional_po_qty_plus_balance < $fields['referrence_group'][0]['referrence_qty'] ){
                        return TransactionValidationMethod::result(400,"Referrence Qty is greater than Total PO Qty, Additional PO Required",array(["referrence_qty"=>$referrence_amount, "total_po_amount"=>$additional_po_amount_plus_balance]));
                    }
                }
