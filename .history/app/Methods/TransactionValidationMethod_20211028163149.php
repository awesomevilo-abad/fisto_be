...
class TransactionValidationMethod
 {
    ...
    public static function insertPartialTransaction($fields,$transaction_id,$po_total_amount,$po_total_qty,$tag_id,$date_requested,$status,$po_no,$balance_po_ref_amount){
    ...
    public static function receiptValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        foreach($fields['po_group'] as $specific_po_details){
            ...
            if(count($balance_ref_po_amount)==0){
                ...
                return (float)$po_total_amount - (float)$fields['referrence_group'][0]['referrence_amount'];
                $balance_po_ref_amount = $po_total_amount - $fields['referrence_group'][0]['referrence_amount'];
            }else{
                return "May laman";
                $balance_ref_po_amount = $balance_ref_po_amount;
            }
        }
        if(isset($duplicate_po)){
            ...
            return $insertTransaction = TransactionValidationMethod::insertPartialTransaction($fields,$transaction_id,$po_total_amount,$po_total_qty,$tag_id,$date_requested,$status,$po_no,$balance_ref_po_amount);
            // return TransactionValidationMethod::result(200,"Request Submitted",$insertTransaction);
