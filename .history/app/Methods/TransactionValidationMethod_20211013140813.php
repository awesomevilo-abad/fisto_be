...
class TransactionValidationMethod
 {
    ...
    public static function insertTransaction($fields,$transaction_id,$po_total_amount,$po_total_qty,$tag_id,$date_requested,$status){
        $new_transaction = Transaction::create([
            ...
            , "payroll_client" => $fields['utilities_consumption']
            , "payroll_category" => $fields['utilities_uom']
            , "payroll_type" => $fields['utilities_receipt_no']
            , "payroll_from" => $fields['utilities_from']
            , "payroll_to" => $fields['utilities_to']
        ]);
    }
