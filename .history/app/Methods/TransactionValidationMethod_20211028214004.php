        ...
        if(isset($existing_po)){
            ...
            if(isset($additional_po)){
                ...
                if($balance_po_ref_amount == 0 ){
                    return TransactionValidationMethod::result(400,"Transaction Closed",array(["referrence_amount"=>$referrence_amount, "total_po_amount"=>$additional_po_amount_plus_balance]));
                }
