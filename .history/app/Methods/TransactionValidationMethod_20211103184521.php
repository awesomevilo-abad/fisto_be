            ...
            if(isset($additional_po)){
                ...
                if((strtoupper($referrence_type)=="DR") AND ($referrence_amount == NULL)){
                    ...
                    if($additional_po_qty_plus_balance == 0 ){
                        return TransactionValidationMethod::result(400,"Transaction or PO Closed",array(["total_po_qty"=>$additional_po_qty_plus_balance]));
                    }
                    ...
                    if($additional_po_amount_plus_balance == 0 ){
                        return TransactionValidationMethod::result(400,"Transaction or PO Closed",array(["total_po_amount"=>$additional_po_amount_plus_balance]));
                    }
