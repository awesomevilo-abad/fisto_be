...
class TransactionValidationMethod
 {
    ...
    public static function insertRefDetails($fields,$tag_id){
        ...
        $insert_ref_group = ReferrenceBatch::create([
            ...
            , "referrence_no" => $$fields['referrence_group'][0]['referrence_type']
            , "referrence_amount" => $$fields['referrence_group'][0]['referrence_type']
            , "referrence_qty" => $$fields['referrence_group'][0]['referrence_type']
        ]);
