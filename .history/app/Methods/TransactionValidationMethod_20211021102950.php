...
class TransactionValidationMethod
 {
    ...
    public static function referrenceNoValidaton($ref_no, $supplier_id){
        if(!isset($ref_no)){
            return TransactionValidationMethod::result(
        ...
        if(GenericMethod::validateIfDocuvalidateIfRefNoExistmentNoExist($doc_no) > 0){
            return TransactionValidationMethod::result(
                403,"Document No. already exist in other Document Types",null
            );
        }
    ...
    public static function insertRefDetails($ref_count,$fields,$tag_id){

        return $fields['ref_group'];
    ...
    public static function receiptValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        $referrenceNoValidation = TransactionValidationMethod::referrenceNoValidaton($fields['referrence_group'][0]['referrence_no'],$fields['supplier_id']);
        ...
        if(strtoupper($fields['payment_type'])=="FULL"){
            ...
            if(strtoupper($referrence_type)=="DR"){
                ...
                return 'INSERT DR TRANSACTION AMOUNT';
            ...
            // $insertPODetails = TransactionValidationMethod::insertPODetails($validated_full_po_transaction['po_count'],$fields,$tag_id);
            $insertPODetails = TransactionValidationMethod::insertRefDetails($validated_full_po_transaction['po_count'],$fields,$tag_id);
        }
            return "Partial";
    }
