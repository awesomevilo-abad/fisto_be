...
class TransactionValidationMethod
 {
    ...
    public static function poValidation($payment_type,$company_id,$supplier_id,po_group){
        ...
        for($i=0;$i<$po_count;$i++){
            ...
            for($k=0;$k<count($fields['po_group'][$i]['rr_group']);$k++){
                $fields['po_group'][$i]['rr_group'][$k]['rr_no'] = TransactionValidationMethod::convertStringToNumber($fields['po_group'][$i]['rr_group'][$k]['rr_no']);
                $fields['po_group'][$i]['rr_group'][$k]['rr_qty'] = TransactionValidationMethod::convertStringToNumber($fields['po_group'][$i]['rr_group'][$k]['rr_qty']);
            }
        ...
        if(isset($duplicate_po_array)){
            return TransactionValidationMethod::result(403,"PO No already exist!",$duplicate_po_array);
        }
    ...
    public static function receiptValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        return TransactionValidationMethod::poValidation($fields['po_group']);
