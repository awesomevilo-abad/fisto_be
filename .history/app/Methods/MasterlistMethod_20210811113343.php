        ...
        if($table == 'categories'){
                ...
                foreach ($users as $specific_user) {
                    ...
                    foreach ($document_types as $specific_document_types) {
                        ...
                        $categories_per_doc_id = $specific_document_types->categories;
                        // $categories_per_doc_id = array_push($specific_document_types->categories, 1);
                        // $categories_per_doc_id = array_push($specific_document_types->categories, 1);
                        $categories_per_doc_id = $specific_document_types->categories[] = "something";
