...
class TransactionValidationMethod
 ...
 public static function insertPODetails($po_count,$fields){
  ...
  public static function padValidation($fields,$tag_id,$date_requested,$staus,$transaction_id){
    ...
    $insertPODetails = TransactionValidationMethod::insertPODetails($po_validation_count,$fields);
    ...
    return TransactionValidationMethod::result(200,"Request Submitted",$new_transaction);
