...
class TransactionValidationMethod
 {
    ...
    public static function insertPartialTransaction($fields,$transaction_id,$po_total_amount,$po_total_qty,$tag_id,$date_requested,$status,$po_no,$balance_po_ref_amount){
        ...
        $balance_po_ref_amount = float($balance_po_ref_amount);
    ...
    public static function receiptValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        if(count($balance_ref_po_amount)==0){
            $balance_po_ref_amount = (float)$po_total_amount - (float)$fields['referrence_group'][0]['referrence_amount'];
        }else{
        ...
        if(isset($duplicate_po)){
            ...
            return $insertPartialTransaction = TransactionValidationMethod::insertPartialTransaction($fields,$transaction_id,$po_total_amount,$po_total_qty,$tag_id,$date_requested,$status,$po_no,$balance_ref_po_amount);
