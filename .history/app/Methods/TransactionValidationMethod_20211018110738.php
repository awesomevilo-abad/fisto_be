...
class TransactionValidationMethod
 {
    ...
    public static function poValidation($payment_type,$company_id,$supplier_id,$po_group){
        ...
        for($i=0;$i<$po_count;$i++){
            ...
            retyrn $GenericMethod::validateIfPONoExist($payment_type,$company_id,$supplier_id,$po_no
    ...
    public static function receiptValidation($fields,$tag_id,$date_requested,$status,$transaction_id){
        ...
        if(strtoupper($fields['payment_type'])=="FULL"){
            return TransactionValidationMethod::poValidation($fields['payment_type'],$fields['company_id'],$fields['supplier_id'],$fields['po_group']);
        }
            return "Partial";
