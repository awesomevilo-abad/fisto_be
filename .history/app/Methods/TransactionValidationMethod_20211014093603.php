...
class TransactionValidationMethod
 {
    ...
    return    $fields['referrence_group'][0]['referrence_amount'] = TransactionValidationMethod::convertStringToNumber($fields['referrence_group'][0]['referrence_amount']);
        ...
        $fields['po_group'][0]['po_amount'] = TransactionValidationMethod::convertStringToNumber($fields['po_group'][0]['po_amount']);
        $fields['po_group'][0]['po_qty'] = TransactionValidationMethod::convertStringToNumber($fields['po_group'][0]['po_qty']);
        $fields['po_group'][0]['rr_group'][0]['rr_no'] = TransactionValidationMethod::convertStringToNumber($fields['po_group'][0]['rr_group'][0]['rr_no']);
        $fields['po_group'][0]['rr_group'][0]['rr_qty'] = TransactionValidationMethod::convertStringToNumber($fields['po_group'][0]['rr_group'][0]['rr_qty']);
